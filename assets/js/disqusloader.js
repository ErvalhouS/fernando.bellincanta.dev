	...
	var extendObj = function (defaults, options) {
		...
		init = function () {
			...
			var winST = window.pageYOffset,
				...
				bounding = instance.getBoundingClientRect();
			...
			if (
				...
				// console.log('visible');
			} else if (offset - winST > window.innerHeight * laziness || winST - offset - instance.offsetHeight - (window.innerHeight * laziness) > 0) {
